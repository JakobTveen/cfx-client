...
Say Hello GET http://localhost:9000/cxf/hello-client/say?who=My_friend
...
You can then execute your native executable with: `./build/cfx-client-1.0.0-SNAPSHOT-runner`
